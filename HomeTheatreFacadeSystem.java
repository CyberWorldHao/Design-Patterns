...
public class HomeTheatreFacadeSystem {
    ...
    public HomeTheatreFacadeSystem(Amplifier amp,
            Tuner tuner,
            DvdPlayer dvd,
            CdPlayer cd,
            Projector projector,
    ...
    public static void main(String[] args) {
        ...
        HomeTheatreFacadeSystem homeTheater
                = new HomeTheatreFacadeSystem(amp, tuner, dvd, cd,
                        projector, screen, lights, popper);

        homeTheater.watchMovie("Violent Night");
